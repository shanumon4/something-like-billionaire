Ext.define('Billionaire.model.Tickets', {
    ...
    config: {
        ...
        fields: [
           ...
           // { name: 'IBoxNumber', type: 'string' },
            { name: 'Sub1' },
            { name: 'Sub2' },
            { name: 'Company', type: 'auto' },
            { name: 'IsIBox', type: 'boolean' },
        ...
        validations: [
            ...
            //{ type: 'format', name: 'IBoxNumber', matcher: /^[0-9]{4}(-|\+)?-[0-9]{1,3}(-|\+)?-[0-9]{1,3}$/, message: "Please enter correct format! eg:1234-1-4" },
            { type: 'format', name: 'FourDNumber', matcher: /^[0-9]{4}(-|\+)?-[0-9]{1,3}(-|\+)?-[0-9]{1,3}$|^\s*$/, message: "Please enter correct format! eg:1234-1-4" },
